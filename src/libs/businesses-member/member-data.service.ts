...
export class MemberService {
  private members: BusinessMember[] = [
    { id: 1, business_id: 1, user_id: 1, role_id: 'Admin', joined_at: '2025-11-19' },
    { id: 2, business_id: 2, user_id: 2, role_id: 'Manager', joined_at: '2025-11-18' },
    { id: 3, business_id: 3, user_id: 3, role_id: 'User', joined_at: '2025-11-17' }
  ];
